...
//    }
//
//    public void addRecord(HistroyModel userModels){
...
//    }
//
//    public HistroyModel getContact(int id) {
...
//            cursor.moveToFirst();
//
//        HistroyModel contact = new HistroyModel(Integer.parseInt(cursor.getString(0)),
//                cursor.getString(1), cursor.getString(2));
//        // return contact
//        return contact;
//    }
//    // get All Record
//    public List<HistroyModel> getAllRecord() {
//        List<HistroyModel> contactList = new ArrayList<HistroyModel>();
//        // Select All Query
...
//            do {
//                HistroyModel userModels = new HistroyModel();
...
//    }
//
//    public int updateContact(HistroyModel contact) {
//        SQLiteDatabase db = this.getWritableDatabase();
//
//        ContentValues values = new ContentValues();
...
//    }
//
//    public void deleteModel(HistroyModel contact) {
//        SQLiteDatabase db = this.getWritableDatabase();
